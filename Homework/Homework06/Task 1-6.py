...
url_list = ['https://gb.ru/lessons/284811/homework', 'https://github.com/BorodinNS']
...
print('Пары чисел кратные пяти и списка выше: ')
print(list(filter(lambda i: (i[0]+i[1])%5 == 0, n_list)))